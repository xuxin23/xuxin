...
public interface WeatherWebServiceSoap {
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetWeatherbyCityName")
    @WebMethod(action = "http://WebXml.com.cn/getWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetWeatherbyCityNameResponse")
    public xuxin.j2ee.webservice.weatherWebService.client.wsdl2java.ArrayOfString getWeatherbyCityName(
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetSupportDataSet")
    @WebMethod(action = "http://WebXml.com.cn/getSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetSupportDataSetResponse")
    public xuxin.j2ee.webservice.weatherWebService.client.wsdl2java.GetSupportDataSetResponse.GetSupportDataSetResult getSupportDataSet();
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetWeatherbyCityNamePro")
    @WebMethod(action = "http://WebXml.com.cn/getWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetWeatherbyCityNameProResponse")
    public xuxin.j2ee.webservice.weatherWebService.client.wsdl2java.ArrayOfString getWeatherbyCityNamePro(
        @WebParam(name = "theCityName", targetNamespace = "http://WebXml.com.cn/")
        java.lang.String theCityName,
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetSupportProvince")
    @WebMethod(action = "http://WebXml.com.cn/getSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetSupportProvinceResponse")
    public xuxin.j2ee.webservice.weatherWebService.client.wsdl2java.ArrayOfString getSupportProvince();
    ...
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetSupportCity")
    @WebMethod(action = "http://WebXml.com.cn/getSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "demo4.weatherWebService.GetSupportCityResponse")
    public xuxin.j2ee.webservice.weatherWebService.client.wsdl2java.ArrayOfString getSupportCity(
